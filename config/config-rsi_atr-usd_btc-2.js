...
//    daterange: 'scan',
//     ..	2019-06-25 13:21	2019-08-02 06:21
    daterange: {
  ...
  candleValues: [ 1 ],
  // candleValues: [14],
  timeoutValues: [ 2, 30, 60, 120, 150, 180, 210, 240, 270, 300, 840, 3600 ],
  ...
  getProperties: () => ({
    ...
    thresholds: {
      ...
      */
      ...
      RSI_HIGH_SELL: 70,
      RSI_LOW_BUY: 30,
      RSI_HIGH_SELL_ALWAYS: 90,
      RSI_LOW_BUY_ALWAYS: 14,
      ...
      */
      ...
      RSI_HIGH_SELL_ALWAYS: randomExt.integer(90, 70),
      RSI_LOW_BUY_ALWAYS: randomExt.integer(20, 10),
      STOP_LOSS_RATIO: randomExt.float(0.99, 0.90).toFixed(2),
      STOP_LOSS_TIMEOUT: randomExt.pick(configRsi_atr.timeoutValues),
      TIMEOUT_EXIT_MINUTES: 2,
      TIMEOUT_EXIT_COEF: randomExt.float(1.10, 0.90).toFixed(2),
    },
  })
